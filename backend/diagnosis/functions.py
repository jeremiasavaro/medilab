...
def create_diagnosis_pdf(patient_name, diagnosis_date, diseases_accepted):
    ...
    if diseases_accepted:
        ...
        elements.append(Paragraph("The patient is healthy with no detected conditions.", body_style))

    elements.append(Spacer(1, 20))

    # Additional warnings
    elements.append(Paragraph("This diagnosis report is generated by MEDILAB’s AI-based system.", small_style))
    elements.append(Spacer(1, 6))
    elements.append(Paragraph("Please consult a healthcare professional for further evaluation.", small_style))
